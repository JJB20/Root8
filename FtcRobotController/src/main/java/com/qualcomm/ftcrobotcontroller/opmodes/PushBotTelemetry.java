...
//
/**
 * Provide info provided by the PushBotHardware class.
 *
 * Insert this class between a custom op-mode and the PushBotHardware class to
 * display info available from the hardware class.
 *
 * @author SSI Robotics
...

{
    ...
    //
    /**
     * Update the info with current values from the base class.
     */
...

    {
        ...
        //
        // Send info data to the driver station.
        //
        telemetry.addData
            ( "01"
            , "Left Drive: "
    ...
    //
    /**
     * Update the info with current gamepad readings.
     */
    public void update_gamepad_telemetry ()

    {
        //
        // Send info data concerning gamepads to the driver station.
        //
    ...
    //
    /**
     * Update the info's first message with the specified message.
     */
    ...
    //
    /**
     * Update the info's first message to indicate an error.
     */
