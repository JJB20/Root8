...
//
/**
 * Provide info provided by the PushBotHardwareSensors class.
 *
 * Insert this class between a custom op-mode and the PushBotHardwareSensors
 * class to display info available from the hardware sensor class.
 *
 * @author SSI Robotics
...

{
    ...
    {
        //
        // Use a base class method to update info for non-sensor hardware
