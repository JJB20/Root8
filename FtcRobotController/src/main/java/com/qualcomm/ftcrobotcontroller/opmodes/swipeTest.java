...
public class swipeTest extends PushBotTelemetrySensors {
...
switch (count) {
	...
	case 17:
		motorLeft.setPower(vl * -0.55);
		motorRight.setPower(vr * -0.55);
		servoDunk.setPosition(.97);
		if(motorRight.getCurrentPosition() < currentPos - 500){
